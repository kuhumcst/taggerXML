...
typedef int (*Registry_CompareFunc)(/*CONSTVOIDP, CONSTVOIDP*/const char*,const char*);
...
extern Bool Registry_add(Registry, /*VOIDP*/char*, VOIDP);
extern Bool Registry_remove(Registry, /*CONSTVOIDP*/const char*);
extern VOIDP Registry_get(Registry, /*CONSTVOIDP*/const char*);
extern VOIDP Registry_get_original_key(Registry, /*CONSTVOIDP*/const char*);
extern VOIDP Registry_replace_value(Registry, /*VOIDP*/char*, /*VOIDP*/char*);
...
extern int Registry_strcmp(/*CONSTVOIDP*/const char*, /*CONSTVOIDP*/const char*);
extern unsigned int Registry_strhash(CONSTVOIDP, unsigned int);
// Bart 20001218//extern int Registry_strcasecmp(CONSTVOIDP, CONSTVOIDP);
extern unsigned int Registry_strcasehash(CONSTVOIDP, unsigned int);

extern void freeRegistry(Registry dir);
extern void freeRegistryOnlyNames(Registry dir);
